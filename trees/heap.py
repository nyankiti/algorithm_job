...
class MiniHeap(object):
    ...
    # popした際に、大きい値が上に来てしまう現象を解消するためのメソッド
    ...
    def push(self, value: int) -> None:
        ...
        self.current_size += 1
        # 入れる値のindex番号がcurrent_sizeと一致するので、以下のようにheapify_upにcurrent_sizeを渡す
    ...
    def pop(self) -> Optional[int]:
        ...
        root = self.heap[1]
        # 以下のpopは配列の組み込みメソッドのpopである。配列の最後の要素を取り出しているだけ。
        data = self.heap.pop()
